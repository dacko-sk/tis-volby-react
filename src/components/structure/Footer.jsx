...
function Footer() {
                ...
                <Row className="justify-content-around gx-md-5 gy-4">
                    ...
                    >
                        <figure className="align-self-center mb-0">
                            ...
                            <figcaption className="small mx-1">
                                Integrity Watch 3.0 is funded by the European
                    ...
                    <Col xs={12}>
                        <p className="donors mt-3 mb-1 fst-italic small text-muted">
                            ...
                            Nadácia Ekopolis v partnerstve s Nadáciou otvorenej
                            spoločnosti Bratislava a Karpatskou nadáciou.
                        </p>
                    </Col>
                    {subsite === 'samosprava2026' && (
                        <Col xs={12}>
                            <p className="mt-1 mb-0 text-center">
                                <Link to={routes.campaignDonors()}>
                                    {t(labels.campaignDonorsLink)}
                                </Link>
                            </p>
                        </Col>
                    )}
                    ...
                    >
                        <figure className="align-self-center mb-0">
                            ...
                            <figcaption className="small mx-1">
                                ...
                                Európskym fondom pre médiá a informácie spočíva
                                výlučne na autorovi/autoroch a nemusí nutne
                                odrážať stanoviská EMIFu a jeho partnerov,
                                nadácie Calouste Gulbenkian a Európskeho
    ...
    const getGithubLink = () => {
        if (subsite === 'samosprava2022')
            return 'https://github.com/dacko-sk/tis-volby-22';
        if (subsite === 'parlament2023')
            return 'https://github.com/dacko-sk/tis-volby-23';
        if (subsite === 'euro2024')
            return 'https://github.com/dacko-sk/tis-volby-euro-24';
        if (subsite === 'prezident2024')
            return 'https://github.com/dacko-sk/tis-volby-prezident-24';
